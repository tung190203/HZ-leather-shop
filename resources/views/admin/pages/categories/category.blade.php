    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-6 mb-2 text-end">
          <button type="button" style="background-color:#5d86fc;box-shadow:0 0 2px black" class="btn m-1"><a href="{{route('admin.category.create')}}" style="color: white ">Add Category</a></button>
        </div>
      </div>
        <div class="row">
                      ...
                      <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="border-bottom-0">
                                <p class="mb-0 fw-normal truncate-text" >{{$category->name}}</p>
                            </td>
                            <td class="border-bottom-0">
                                {{$category->created_at}}
                            </td>
