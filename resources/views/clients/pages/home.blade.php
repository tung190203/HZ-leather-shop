        ...
        <div id="carouselExample" class="carousel slide carousel-fade" data-ride="carousel">
          <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="./assets/img/categories/category-2.jpg" class="d-block w-100 " style="max-height:600px"  alt="Slide 1">
              </div>
              <div class="carousel-item">
                  <img src="./assets/img/categories/category-1.jpg" class="d-block w-100 " style="max-height:600px"  alt="Slide 2">
              </div>
              <div class="carousel-item">
                  <img src="./assets/img/categories/category-3.jpg" class="d-block w-100 " style="max-height:600px"  alt="Slide 3">
              </div>
          </div>
          <!-- Controls -->
