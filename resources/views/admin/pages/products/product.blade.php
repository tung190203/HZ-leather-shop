    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-6 mb-3 text-end">
          <button type="button" style="background-color:#5d86fc;box-shadow:0 0 2px black" class="btn m-1"><a href="{{route('admin.export.product')}}" style="color: white "> <i class="ti ti-download fs-5"></i> Export</a></button>
          <button type="button" style="background-color:#6ac8fd;box-shadow:0 0 2px black" class="btn m-1"><a href="{{route('admin.product.create')}}" style="color: white ">Add Product</a></button>
        </div>
      </div>
        <div class="row">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="border-bottom-0">
                                ...
                                <span class="fw-normal">{{$product->categories->name}}</span>                          
                            </td>
                            <td class="border-bottom-0">                              
                              <img src="{{ Storage::disk('minio')->url($product->images) }}" width="75" height="75" class="rounded" alt="Product Image">
                            </td>
                            <td class="border-bottom-0">
