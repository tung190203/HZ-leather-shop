                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        ...
                                                        <a href="../horizontal/app-calendar.html"
                                                            class="d-flex align-items-center pb-9 position-relative">
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                        ...
                                                        <a href="../horizontal/app-contact.html"
                                                            class="d-flex align-items-center pb-9 position-relative">
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center ">
                                ...
                                <a class="nav-link position-relative nav-icon-hover" href="javascript:void(0)"
                                    ...
                                    @php
                                        $carts = App\Models\Cart::where('user_id', auth()->user()->id)
                                            ->where('status', config('default.cart.status.pending'))
                                            ->count();
                                    @endphp
                                    @if($carts > 0)
                            ...
                            <li class="nav-item dropdown">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div
                                        class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"aria-labelledby="drop2">
                                        <div class="d-flex align-items-center justify-content-between py-3 px-7">
                                            <h5 class="mb-0 fs-5 fw-semibold">Notifications</h5>
                                            <span class="badge text-bg-primary rounded-4 px-3 py-1 lh-sm">5
                                                new</span>
                                        </div>
                                        <div style="max-height:300px;overflow-y:auto;padding: 30px;">
                                    ...
                                    <div class="w-75 d-inline-block v-middle">
                                        ...
                                        <div class="py-6 px-7 mb-1">
                                            <button type="button" class="btn btn-outline-primary w-100 mt-2">See All
                                    ...
                                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                        ...
                                        @if (auth()->user()->avatar)
                                            <img src="{{ Storage::disk('minio')->url(auth()->user()->avatar) }}"
                                                alt="userImage" class="rounded-circle" width="40"
                                                height="40">
                                        @else
                                        ...
                                        <div class="message-body">
                                            @if (auth()->user()->role == 'admin')
                                                <a href="{{ route('admin.dashboard') }}"
                                                    ...
                                                    <span
                                                        class="d-flex align-items-center justify-content-center text-bg-danger rounded-1 p-6">
                                                        <i class="ti ti-user fs-4"></i>
                                                    </span>
                                                    <div class="w-75 d-inline-block v-middle ps-3">
                                                        <h6 class="mb-1 fs-3 fw-semibold lh-base">Admin Dashboard</h6>
                                                        <span class="fs-2 d-block text-body-secondary">Management this
                                                            shop</span>
                                                    </div>
                                                </a>
                                            @endif
                                            ...
                                            <a href="{{ route('client.cart') }}"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h6 class="mb-1 fs-3 fw-semibold lh-base">My Shopping Cart</h6>
                                                    <span class="fs-2 d-block text-body-secondary">Management your
                                                        Cart</span>
                                                </div>
                                            </a>
