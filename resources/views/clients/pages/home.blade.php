            ...
            <div id="carouselExample" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./assets/img/categories/category-2.jpg" class="d-block w-100 " style="max-height:600px"
                            alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/img/categories/category-1.jpg" class="d-block w-100 " style="max-height:600px"
                            alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/img/categories/category-3.jpg" class="d-block w-100 " style="max-height:600px"
                            alt="Slide 3">
                    </div>
                </div>
                <!-- Controls -->
    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row property__gallery">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-1.jpg">
                            ...
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-1.jpg" class="image-popup"><span
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix men">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-2.jpg">
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-2.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix accessories">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-3.jpg">
                            <div class="label stockout">out of stock</div>
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-3.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix cosmetic">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-4.jpg">
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-4.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix kid">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-5.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix women men kid accessories cosmetic">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-6.jpg">
                            <div class="label sale">Sale</div>
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-6.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix women men kid accessories cosmetic">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-7.jpg">
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-7.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mix women men kid accessories cosmetic">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-8.jpg">
                            ...
                            <ul class="product__hover">
                                <li><a href="./assets/img/product/product-8.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
