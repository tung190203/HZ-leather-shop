            ...
            @if (count($carts) > 0)
                    ...
                    <ul class="mb-0">
                        <li class="pb-7">
                            <div class="d-flex align-items-center">
                                <img src="{{ Storage::disk('minio')->url($cart->product->images) }}" width="95"
                                    height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                                <div>
                                    <h6 class="mb-1"
                                        style="max-width:95%; overflow: hidden; text-overflow: ellipsis;  white-space: nowrap;">
                ...
                @endphp
                  <div class="align-bottom">
                    ...
                    <div class="align-bottom">
                        <a href="{{ route('client.checkout') }}" class="btn btn-outline-primary w-100">Go to Checkout</a>
                    </div>
                </div>
            @else
